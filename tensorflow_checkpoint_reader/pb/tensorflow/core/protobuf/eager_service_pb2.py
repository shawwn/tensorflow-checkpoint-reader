...
from ..framework import function_pb2 as tensorflow_dot_core_dot_framework_dot_function__pb2
...
from ..framework import versions_pb2 as tensorflow_dot_core_dot_framework_dot_versions__pb2
from ..protobuf import remote_tensor_handle_pb2 as tensorflow_dot_core_dot_protobuf_dot_remote__tensor__handle__pb2
from ..protobuf import tensorflow_server_pb2 as tensorflow_dot_core_dot_protobuf_dot_tensorflow__server__pb2
...
_QUEUERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='device', full_name='tensorflow.eager.QueueResponse.device', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='tensorflow.eager.QueueResponse.tensor', index=2,
...
_RUNCOMPONENTFUNCTIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='output_num', full_name='tensorflow.eager.RunComponentFunctionRequest.output_num', index=2,
