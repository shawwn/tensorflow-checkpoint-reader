...
from ..framework import summary_pb2 as tensorflow_dot_core_dot_framework_dot_summary__pb2
...
_REQUESTEDEXITCODE = _descriptor.Descriptor(
  ...
  full_name='tensorflow.RequestedExitCode',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='exit_code', full_name='tensorflow.RequestedExitCode.exit_code', index=0,
...
_WORKERHEARTBEATREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='exit_code', full_name='tensorflow.WorkerHeartbeatRequest.exit_code', index=2,
